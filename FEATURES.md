...
- Classic film-graph speedruns (movie ↔ person)
- Neo-brutalist UI + launch match generator
- Soft hints mid-run (costs 1 click each, max 3)
...
- (open) polish share UX for person-endpoint challenges

## Explicitly skipped for now

- Daily challenge
- Persistent / real database leaderboard
- Accounts, friends, multiplayer races
